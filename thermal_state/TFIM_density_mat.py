...
def state_free_energy(params, circuit):
    """
    ...
    """   
    sfr = thermal_state.free_energy(circuit,params,'density_matrix',L,H_mat,T,chi_H,prob_list,bdry_vecs1,bdry_vecs2,None)  
    return sfr

# optimization 
result = minimize(state_free_energy,x0=params,args=(c),method = TBD,options={'disp': True})
sweet_spot = result.x
F_density = state_free_energy(sweet_spot,c)
