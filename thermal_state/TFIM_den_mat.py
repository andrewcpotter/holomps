...
# free energy
def free_energy(params, circuit, L, T, Hamiltonian, chi_H, bdry_vecs1, bdry_vecs2):
    """
    ...
    """   
    F = thermal_state.free_energy(circuit,params,'density_matrix',L,Hamiltonian,T,chi_H,bdry_vecs1,bdry_vecs2,None)  
    return F
...
# optimization 
result = minimize(free_energy,x0=params,args=(c,L,T,Hamiltonian,chi_H,bdry_vecs1,bdry_vecs2),method = 'TBD',options={'disp': True})
sweet_spot = result.x
F_density = free_energy(sweet_spot,c,L,T,Hamiltonian,chi_H,bdry_vecs1,bdry_vecs2)
