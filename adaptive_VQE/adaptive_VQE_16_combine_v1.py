...
Entangler_pool = [\
XX_YYGate(qids = [0,4], fn = qub_two),XX_YYGate(qids = [0,5], fn = qub_two),\
XX_YYGate(qids = [1,4], fn = qub_two),XX_YYGate(qids = [1,5], fn = qub_two),XX_YYGate(qids = [2,4], fn = qub_two),\
XX_YYGate(qids = [2,5], fn = qub_two),XX_YYGate(qids = [3,4], fn = qub_two),XX_YYGate(qids = [3,5], fn = qub_two),\
XX_YYGate(qids = [4,5], fn = qub_two),\
ZZGate(qids = [0,4], fn = qub_two),ZZGate(qids = [0,5], fn = qub_two),\
ZZGate(qids = [1,4], fn = qub_two),ZZGate(qids = [1,5], fn = qub_two),ZZGate(qids = [2,4], fn = qub_two),\
ZZGate(qids = [2,5], fn = qub_two),ZZGate(qids = [3,4], fn = qub_two),ZZGate(qids = [3,5], fn = qub_two),\
ZZGate(qids = [4,5], fn = qub_two)]
