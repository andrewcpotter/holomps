...
0.01,0.02,0.03,0.09]
params_per = 14
params_better_list = bond_4_sweet_spot[0: params_per] + constant_list[0: 2*params_per] + \
bond_4_sweet_spot[params_per: 2 * params_per] + constant_list[2*params_per: 4*params_per]
