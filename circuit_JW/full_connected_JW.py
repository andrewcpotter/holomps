import time
import numpy as np
from circuit_qubit_JW import Circuit
...
def fermi_hubbard_half_filling_fully_connected(t_value, U_value, mu_value, local_choice, global_iter, C_para, start_option, better_start):
    ...
    c.add_gate("XX", qids=[1, 3], n_params = 1, fn = qub_two)
    c.add_gate("YY", qids=[1, 3], n_params = 1, fn = qub_two)        
    ...
    c.add_gate("XX", qids=[2, 3], n_params = 1, fn = qub_two)
    c.add_gate("YY", qids=[2, 3], n_params = 1, fn = qub_two)    
    ...
    c.add_gate("XX", qids=[0, 4], n_params = 1, fn = qub_two)
    c.add_gate("YY", qids=[0, 4], n_params = 1, fn = qub_two)
    c.add_gate("ZZ", qids=[0, 4], n_params = 1, fn = qub_two)
    c.add_gate("XX", qids=[1, 5], n_params = 1, fn = qub_two)
    c.add_gate("YY", qids=[1, 5], n_params = 1, fn = qub_two)        
    c.add_gate("ZZ", qids=[1, 5], n_params = 1, fn = qub_two)
	
    c.add_gate("XX", qids=[0, 1], n_params = 1, fn = qub_two)
    c.add_gate("YY", qids=[0, 1], n_params = 1, fn = qub_two)    
    c.add_gate("ZZ", qids=[0, 1], n_params = 1, fn = qub_two)
    c.add_gate("XX", qids=[4, 5], n_params = 1, fn = qub_two)
    c.add_gate("YY", qids=[4, 5], n_params = 1, fn = qub_two)    
    ...
    c.add_gate("XX", qids=[2, 4], n_params = 1, fn = qub_two)
    c.add_gate("YY", qids=[2, 4], n_params = 1, fn = qub_two)
    c.add_gate("ZZ", qids=[2, 4], n_params = 1, fn = qub_two)
    c.add_gate("XX", qids=[3, 5], n_params = 1, fn = qub_two)
    c.add_gate("YY", qids=[3, 5], n_params = 1, fn = qub_two)    
    ...
    c1.add_gate("XX", qids=[0, 2], n_params = 1, fn = qub_two)
    c1.add_gate("YY", qids=[0, 2], n_params = 1, fn = qub_two)
    c1.add_gate("ZZ", qids=[0, 2], n_params = 1, fn = qub_two)
    c1.add_gate("XX", qids=[1, 3], n_params = 1, fn = qub_two)
    c1.add_gate("YY", qids=[1, 3], n_params = 1, fn = qub_two)        
    c1.add_gate("ZZ", qids=[1, 3], n_params = 1, fn = qub_two)
	
    c1.add_gate("XX", qids=[0, 1], n_params = 1, fn = qub_two)
    c1.add_gate("YY", qids=[0, 1], n_params = 1, fn = qub_two)    
    c1.add_gate("ZZ", qids=[0, 1], n_params = 1, fn = qub_two)
    c1.add_gate("XX", qids=[2, 3], n_params = 1, fn = qub_two)
    c1.add_gate("YY", qids=[2, 3], n_params = 1, fn = qub_two)    
    ...
    c1.add_gate("XX", qids=[0, 4], n_params = 1, fn = qub_two)
    c1.add_gate("YY", qids=[0, 4], n_params = 1, fn = qub_two)
    c1.add_gate("ZZ", qids=[0, 4], n_params = 1, fn = qub_two)
    c1.add_gate("XX", qids=[1, 5], n_params = 1, fn = qub_two)
    c1.add_gate("YY", qids=[1, 5], n_params = 1, fn = qub_two)        
    c1.add_gate("ZZ", qids=[1, 5], n_params = 1, fn = qub_two)
	
    c1.add_gate("XX", qids=[0, 1], n_params = 1, fn = qub_two)
    c1.add_gate("YY", qids=[0, 1], n_params = 1, fn = qub_two)    
    c1.add_gate("ZZ", qids=[0, 1], n_params = 1, fn = qub_two)
    c1.add_gate("XX", qids=[4, 5], n_params = 1, fn = qub_two)
    c1.add_gate("YY", qids=[4, 5], n_params = 1, fn = qub_two)    
    ...
    c1.add_gate("XX", qids=[2, 4], n_params = 1, fn = qub_two)
    c1.add_gate("YY", qids=[2, 4], n_params = 1, fn = qub_two)
    c1.add_gate("ZZ", qids=[2, 4], n_params = 1, fn = qub_two)
    c1.add_gate("XX", qids=[3, 5], n_params = 1, fn = qub_two)
    c1.add_gate("YY", qids=[3, 5], n_params = 1, fn = qub_two)    
