...
# one qubit rotation
    ...
    t = t_value
    U = U_value
    W = [[Id, None, None, None, None, None],\
    [C_du, None, None, None, None, None],\
    [C_u, None, None, None, None, None],\
    [C_dd, None, None, None, None, None],\
    [C_d, None, None, None, None, None],\
    [U*NuNd, -t*C_u, -t*C_du, -t*C_d, -t*C_dd, Id]]
    Hamiltonian = MPO.from_grids(2*[site],2*[W],bc='infinite',IdL=0,IdR=-1)
    # use tenpy MPOGraph to construct MPO:
