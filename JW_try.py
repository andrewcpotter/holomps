...
def fermi_hubbard_half_filling_more_entanglement(t_value, U_value, mu_value, ansatz_type, optimizer_choice, global_iter, C_para, params_start_option, params_start_given):
    ...
    if ansatz_type == 0:
        ...
        c.add_gate("XX", qids=[0, 3], n_params = 1, fn = qub_two)
        c.add_gate("YY", qids=[0, 3], n_params = 1, fn = qub_two)
        c.add_gate("ZZ", qids = [0, 3], n_params = 1, fn = qub_two)
        c.add_gate("XX", qids=[1, 2], n_params = 1, fn = qub_two)
        c.add_gate("YY", qids=[1, 2], n_params = 1, fn = qub_two)
...
# one qubit rotation
    ...
    if ansatz_type == 0:
        ...
        c1.add_gate("XX", qids=[0, 3], n_params = 1, fn = qub_two)
        c1.add_gate("YY", qids=[0, 3], n_params = 1, fn = qub_two)
        c1.add_gate("ZZ", qids = [0, 3], n_params = 1, fn = qub_two)
        c1.add_gate("XX", qids=[1, 2], n_params = 1, fn = qub_two)
        c1.add_gate("YY", qids=[1, 2], n_params = 1, fn = qub_two)
